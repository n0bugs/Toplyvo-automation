...
public class BuyFromMapPage extends AndroidSetUp {
    ...
    private SelenideElement glusco = $(By.xpath("//android.view.View[@content-desc=\"Карта Google\"]/android.view.View[7]"));

    private SelenideElement firstDiesel = $(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/" +
    ...
    private SelenideElement btnContinueAfterDiesel = $(By.xpath("/hierarchy/android.widget.FrameLayout/" +
            "android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/" +
